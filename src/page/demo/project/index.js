        ...
        return (
            ...
            renderItem={(item,i)=> 
                    ...
                    <div className="p-title" style={{marginBottom:'10px'}}>
                        <p  className="desc" style={{fontSize:"0.15rem",fontWeight:"bold"}}><i>
                        <img className="img-cover" src={item.icon} style={{width:"36px",borderRadius:"50%",marginRight:"10px"}}/></i>{item.name}</p>
                    </div>
                    <img className="img-cover" src={item.image} style={{width:"100%",marginBottom:'10px'}}/>
                        <div className="des" style={{paddingRight:"0.1rem",fontSize:"0.14rem"}}>
                                <p className="desc">{item.category}</p>       
                                <p className="desc"><a href={item.url}>{item.url}</a></p>
